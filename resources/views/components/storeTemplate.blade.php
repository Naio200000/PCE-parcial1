        ...
        <header class="header">
            <nav class="navbar navbar-expand-md fixed-top container-fluid x-auto ">
                <div class="nav container align-items-center">
                    <a class="navbar-brand " href="{{route('home')}}"><img src="{{url('storage/img/logo/komei_Juku.webp')}}" alt="Logo de la escuela"></a>
        ...
        <footer class="container-fluid mb-lg-0 footer">
            <div class="container-md">
                <div class="row align-items-center">
                    ...
                    <img class="imagen-perfil footer-perfil" src="{{url('storage/img/misc/perfil.webp')}}" alt="Un señor muy buen moso">
                    </div>
                    <div class="col">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-7">
                                <ul class="row social">
                                    <li class="col"><a href="https://www.instagram.com/nicolas.alsinet/" target="_blank"><img src="{{url('storage/img/logo/SVG/Instagram_logo_2016.svg')}}" alt="Logo de Instagram"></a></li>
                                    <li class="col"><a href="https://www.linkedin.com/in/nicolas-alsinet-99a067226/" target="_blank"><img src="{{url('storage/img/logo/SVG/LinkedIn_icon.svg')}}" alt="Logo de linkedin"></a></li>
                                    <li class="col"><a href="https://github.com/Naio200000" target="_blank"><img src="{{url('storage/img/logo/SVG/github_icon.svg')}}" alt="Logo de Github"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
