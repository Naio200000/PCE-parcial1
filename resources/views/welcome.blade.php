...
<x-storeTemplate>
    ...
    <section class="hero">
        <section class="home container-fluid container-md">
            ...
            <p class="pe-md-3 fs-5 w-75 mx-auto text-center"><strong>Komei Juku Argentina</strong> es una escuela esgrima japonesa <em>Muso Jikiden Eishin Ryu</em>.</p>
            <p class="pe-md-3 fs-5 w-75 mx-auto text-center">Ofresemos <strong>clases</strong> en varios dojos, <strong>ropa</strong> de practica y <strong>equipos</strong> en general.</p>
            <p class="pe-md-3 fs-5 w-75 mx-auto text-center"><a href="{{route('contactos')}}" class=""><em><b>Contactanos</b></em></a> por cualquier duda que tengas, estamos a tu disposición.</p>
        </section>
        <div id="CarrpuselHero" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item <?= ($c == 0) ? 'active' : '' ?>" data-bs-interval="10000">
                    <div class="heroBanner d-flex flex-column justify-content-around pt-5" style="background-image: url({{'storage/img/hero/' . $n->image}});">
