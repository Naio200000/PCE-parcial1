        ...
        <article class="accordion" id="accordionDojo">
            <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionDojo">
                    ...
                    <div class="dojo-acordion text-end me-5 mb-3">
                        <button type="button" class="btn btn-komei" data-bs-toggle="modal" data-bs-target="#modalContactoDojos" data-bs-whatever="@chikaradojo">Contacto</button>
                    </div>
                </div>
            </div>
            <div class="accordion-item">
            ...
            <div class="accordion-item">
                ...
                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionDojo">
                    ...
                    <div class="dojo-acordion text-end me-5 mb-3">
                        <button type="button" class="btn btn btn-komei" data-bs-toggle="modal" data-bs-target="#modalContactoDojos" data-bs-whatever="@eltemplodojo">Contacto</button>
                    </div>
                </div>
            </div>
        </article>
